        ...
        */
        RongIMVoice.init = function () {
            if (this.isIE) {
                ...
                script.src = "//tres.youziv.com/assets/js/audio/amr64/swfobject-2.0.0.min.js";
                ...
                setTimeout(function () {
                    ...
                    swfobject.embedSWF("//tres.youziv.com/assets/js/audio/amr64/player-2.0.2.swf", "flashContent", "1", "1", swfVersionStr, null, flashvars, params, attributes);
                }, 200);
            }
            else {
                var list = ["//tres.youziv.com/assets/js/audio/amr64/pcmdata-2.0.0.min.js", "//tres.youziv.com/assets/js/audio/amr64/libamr-2.0.1.min.js"];
 ...
 function fetchBlob(url , callback) {
	...
	var xhr = new XMLHttpRequest();
	   ...
	   // xhr.responseType = 'arraybuffer';
		...
		RongIMLib.RongIMVoice.play(this.response);
